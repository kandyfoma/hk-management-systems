...
import INVENTORY_TEMPLATE_PRODUCTS from '../data/inventoryTemplateProducts';
import {
...
export function InventoryScreen() {
  ...
  // ─── Import: Template data (100 realistic products for DRC/Congo pharmacy) ───
  const TEMPLATE_MEDICATIONS = INVENTORY_TEMPLATE_PRODUCTS;
